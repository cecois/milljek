...
var BaseLayer = Backbone.Model.extend({defaults:{active:false},initialize:function(){}}); //BaseLayer
...
stylize: function(gtype,active,seen){
        ...
        **/
        ...
        if(typeof gtype == 'undefined'){var gtype = 'poly';}
        if(typeof active == 'undefined'){var active = 0;}
        if(typeof seen == 'undefined'){var seen = 0;}
