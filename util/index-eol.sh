...
jekyls_raw=$(find /Users/ccmiller/git/eoljek/_site -d -type f -iname "*.html" -not -iname "index*")
...
rsync -r /Users/ccmiller/git/eoljek/_site/ /Users/ccmiller/git/eolapp/_site